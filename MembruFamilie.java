/**
	 * Clasa care inheriteaza Pasager si descrie un membru dintr-o familie.
	 */
public class MembruFamilie extends Pasager {
	
	public MembruFamilie(String id, String nume, int varsta, String tipBilet, boolean prioritar, boolean andicap) {
